...
(function(window)
{
	...
	function ImageSlider(slider, _slides, varsObj)
	{
		...
		var _vars = $.extend({ minDragDistance:100, animDuration:0.3, maxZoom:2, minZoom:1, ease:Power4.easeOut, loop:true, allowZoom:true, allowDrag:true, doubleTapZoom:2, zoomStep:0.5, dragStep:10, adjustWidth:0, adjustHeight:0, playDuration:5, autoPlay:false, loadIndexOnly:true, preloaderUrl:"assets/preloader.gif", resizeDuration:-1 }, varsObj),
			_slider = $(slider),
